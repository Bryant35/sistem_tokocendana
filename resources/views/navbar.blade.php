...
<body>
    <div class="mx-5">
        <nav class="navbar navbar-collapse dark mx-5">
            ...
            <li class="nav-item dropdown " style="text-decoration: black; list-style: none;">
                <a class="nav-item dropdown-toggle text-reset" href="#" id="navbarToko" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: black;">
                Toko
                </a>
            ...
            <li class="nav-item dropdown" style="text-decoration: black; list-style: none; ">
                <a class="nav-item dropdown-toggle text-reset" href="#" id="navbarGudang" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: black;">
                Gudang
                </a>
            ...
            <a class="nav-item text-reset" href="#" style="text-decoration: none;">Pegawai</a>
            <a class="nav-item text-reset" href="#" style="text-decoration: none;">Customer</a>
            <li class="nav-item dropdown" style="text-decoration: black; list-style: none; ">
                <a class="nav-item dropdown-toggle text-reset" href="#" id="navbarLaporan" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="text-decoration: black;">
                Laporan
                </a>
