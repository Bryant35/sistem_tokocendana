...
<body>
    @include('navbar')
    <div class="container">
        <h1 class="fw-bold">Update Transaksi Penjualan</h1>
        <div class="col">
            <div class="card">
        ...
        <div class="row mt-4">
            ...
            <div class="col-1" style="display: flex;justify-content: flex-end;">
                <div class="btn border-end border-bottom border-3 rounded fw-bold shadow bg-body" style="background-color:white; color: #1672EC;"><span>Update</span></div>
            </div>
        </div>
    </div>
</body>
