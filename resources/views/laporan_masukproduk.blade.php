...
<head>
        ...
        <title>Laporan Stok Masuk - Cendana Snack</title>
...
<body>
    <div class="container">
        <div class="row" style="margin-right:0.25rem; margin-top:15px">
            <h1 style="margin-top: 0.25rem; width:390px">Stok Masuk / <span><a href="/laporankeluarproduk" class="menu-btn">Keluar</a><span></h1>
            ...
            <table class="table table-striped table-hover border rounded">
                <thead>
                    <tr>
                        ...
                        <tbody>
                            @foreach($masuk as $kon)
                                <tr>
                                    <th>{{$kon->MENTAH_ID}}</th>
                                    <td>{{$kon->NAMA_PRODUK}}</td>
                                    <td>{{$kon->JENIS_PRODUK}}</td>
                                    <td>{{$kon->JML_PRODUK}}</td>
                                    <td>{{$kon->EXPIRED_PRODUK}}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </tr>
